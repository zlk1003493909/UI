...
{
  ui_para.ani_param[TILE_ANI] = 200;  // 磁贴动画速度
  ui_para.ani_param[LIST_ANI] = 200;  // 列表动画速度
  ui_para.ani_param[WIN_ANI] = 200;   // 弹窗动画速度
...
//   ui_para.ani_param[FADE_ANI] = 30;  // 消失动画速度
  ...
  ui_para.raderpic_scan_rate = 50;        //镭射文字扫描速度
  ui_para.raderpic_move_rate = 200;        //镭射文字移动速度
}
